  ...
  },
  {
    ...
    its: [
      ...
      },
      {
        ...
        componentDidMount: () => {
          createDriver().scrollHorizontallyBy(250);
        },
      },
      {
        ...
        componentDidMount: () => {
          createDriver().scrollHorizontallyBy(99999);
        },
      },
      {
        ...
        componentDidMount: () => {
          createDriver().scrollHorizontallyBy(200);
        },
      },
      {
...
const InteractiveTable = ({ componentDidMount, ...props }) => {
  useEffect(() => {
