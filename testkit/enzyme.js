...
export const checkToggleTestkitFactory = enzymeUniTestkitFactoryCreator(load(require('../src/CheckToggle/CheckToggle.uni.driver')));
...
export const listItemEditableTestkitFactory = enzymeUniTestkitFactoryCreator(load(require('../src/ListItemEditable/ListItemEditable.uni.driver')));
