...
export const checkToggleTestkitFactory = uniTestkitFactoryCreator(load(require('../src/CheckToggle/CheckToggle.uni.driver')));
...
export const listItemEditableTestkitFactory = uniTestkitFactoryCreator(load(require('../src/ListItemEditable/ListItemEditable.uni.driver')));
